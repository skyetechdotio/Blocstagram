...
//  Blocstagram
//
//  Created by Daniel Rodas on 3/30/16.
...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *item1 = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemReply target:self action:@selector(LoadLoginPage:)];
